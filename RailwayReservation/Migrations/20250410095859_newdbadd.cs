        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Notifications_Trains_TrainID",
                        column: x => x.TrainID,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SeatAvailabilities_ClassTypes_ClassTypeID",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_WaitingLists_ClassTypes_ClassTypeID",
                        column: x => x.ClassTypeID,
                        principalTable: "ClassTypes",
                        principalColumn: "ClassTypeID",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SeatAvailabilities_TrainID",
                table: "SeatAvailabilities",
                column: "TrainID");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WaitingLists_ClassTypeID",
                table: "WaitingLists",
                column: "ClassTypeID");
